...
CREATE TABLE `t_course` (
  `course_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` int(11) NOT NULL COMMENT '授课老师主键ID',
  `course_name` varchar(128) NOT NULL DEFAULT '' COMMENT '课程名称',
  `pic_url` varchar(100) DEFAULT '' COMMENT '封面图片路径',
  `pdf_url` varchar(100) DEFAULT '' COMMENT 'pdf路径',
  `video_url` varchar(100) DEFAULT '' COMMENT '视频路径',
  `remark` text COMMENT '课程描述',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '0' COMMENT '课程状态（0正常 1停用）',
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='教学中心: 课程管理';
